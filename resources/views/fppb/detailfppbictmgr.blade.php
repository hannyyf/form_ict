...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/index') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="tip-bottom">List Approve ICT Manager</a><a href="#" class="current">Detail</a></div>
    <h1>Detail</h1>
  </div>
<!--End-breadcrumbs-->
...
<div class="container-fluid">
    <div class="row-fluid">
        <form action="{{ route('approveictmgr.store') }}" method="post" class="form-horizontal"> 
                {{ csrf_field() }}
        <div class="span12">
                    ...
                    <table class="table table-bordered table-striped with-check" id="table-list" style="width: 100%">
                        ...
                        <tr>
                           <td style="width: 2%">
                            ...
                            <td style="width: 20%">
                                <input class="budget span11" type="text" name="budget[]" id="budget" style="width:80%;" value="{{ $data->perkiraanbudget }}">
                            </td>
                        </tr>
                        </tbody>
                         @endforeach
