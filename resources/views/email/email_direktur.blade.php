                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        ...
                                        <p>Mohon untuk dapat melakukan review dan approval terhadap FPPB dengan nomor <b>{{ $nofppb }}</b>, dengan detail sebagai berikut :</p>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td><p>Divisi Request : {{ $divisi }}</p></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </td>
