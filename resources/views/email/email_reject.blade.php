                        ...
                        <td class="wrapper">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Dear Requester,</p>
                                        <p>Request FPPB anda dengan nomor <b>{{ $nofppb }}</b>, belum disetujui oleh Bpk/Ibu <b> {{ $appraiser }}</b> dengan alasan <b>{{ $reason }}</b>. Berikut detail dari FPPB yang anda request :</p>
