                    ...
                    <tr>
                        <td class="wrapper">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Dear Plant / Commercial / Director,</p>
                                        <p>Mohon untuk dapat melakukan review dan approval terhadap FPPB dengan nomor <b><?php echo e($nofppb); ?></b>, dengan detail sebagai berikut :</p>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <td align="left">
                                                 <table border="1" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tbody id="listitem">
                                                        <tr>
                                                            <td style="text-align: center;"><?php echo e($data->seqid); ?></td>
                                                            <td style="text-align: center;"><?php echo e($data->jenisbarang); ?></td>
                                            ...
                                            <tr>
                                                <td><p>Divisi Request : <?php echo e($divisi); ?></p></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                <span class="apple-link">ICT PT Djabesmen </span>
                            </td>
                        </tr>
                    </table>
                </div>
