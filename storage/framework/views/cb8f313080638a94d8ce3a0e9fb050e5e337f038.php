...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo e(url('/index')); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="tip-bottom">List Approve Div Head</a><a href="#" class="current">Detail</a></div>
    <h1>Detail</h1>
  </div>
<!--End-breadcrumbs-->
...
<div class="container-fluid">
    <div class="row-fluid">
        <form action="<?php echo e(route('approvedivhead.store')); ?>" method="post" class="form-horizontal"> 
