    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="control-group form-group<?php echo e($errors->has('identity') ? ' has-error' : ''); ?>">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input id="identity" type="text" placeholder="NIK" name="identity" value="<?php echo e(old('identity')); ?>" style="background-color: #dedede" required autofocus/>
                ...
                <div class="control-group form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                    <div class="controls">
                        <div class="main_input_box">
