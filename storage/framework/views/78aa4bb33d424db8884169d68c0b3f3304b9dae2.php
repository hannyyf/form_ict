...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo e(url('/index')); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="tip-bottom">List Approve DIC</a><a href="#" class="current">Detail</a></div>
    <h1>Detail</h1>
  </div>
<!--End-breadcrumbs-->
...
<div class="container-fluid">
    <div class="row-fluid">
        <form action="<?php echo e(route('approvedic.store')); ?>" method="post" class="form-horizontal"> 
        ...
        <div class="span12">
            ...
            <div class="control-group">
             ...
             <div class="widget-box">
                        ...
                        <tr>
                           <td style="width: 2%">
                            ...
                            <td style="width: 15%">
                                ...
                                <input class="budget span11" type="text" name="budget[]" id="budget" style="display:none;" value="<?php echo e($data->perkiraanbudget); ?>" >
                            </td>
                        </tr>
                        </tbody>
                ...
                <div class="col-md-6 pull-left" style="margin-left: : 25px">
                    <textarea class="span11" type="text" name="noteict" id="noteict" rows="5" cols="40" placeholder="Rekomendasi ICT" readonly="readonly"><?php echo $header->noteict;?></textarea>
                </div>
                 <div class="col-md-6 pull-left" style="margin-left: : 25px">
                ...
                <div class="col-md-4 pull-right" style="margin-right: 25px; margin-top: 10px" >
                    <table border="1">
                        <tr>
                            <td>
                                <p>Log :</p>
