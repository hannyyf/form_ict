...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo e(url('/index')); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current">List Review ICT</a></div>
    <h1>List Review ICT</h1>
  </div>
<!--End-breadcrumbs-->
             ...
             <table class="table table-bordered table-striped">
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo e(url('/detailict/'.$datas->notrx)); ?>" method="get">
