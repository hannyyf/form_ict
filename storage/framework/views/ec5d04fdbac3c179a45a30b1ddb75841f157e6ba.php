            ...
            <div class="control-group">
             ...
             <div class="widget-box">
                <div class="widget-content nopadding">
                    <table class="table table-bordered table-striped table-responsive" id="table-list" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 15%">
                                <input class="budget span11" type="text" name="budget[]" id="budget" style="width:100%;">
                            </td>
                ...
                <div class="col-md-6 pull-left" style="margin-left: 25px">
                    <textarea class="span11" type="text" name="noteict" id="noteict" rows="5" cols="50" placeholder="Rekomendasi ICT"></textarea>
                </div>
                <div class="col-md-6 pull-left" style="margin-left: 25px; margin-top: 10px">
