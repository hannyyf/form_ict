...
<script type="text/javascript">
    ...
    function tambahItem(line) {
        ...
        row = 
            '<tr>' +
                '<td style="width: 90%;padding: 0px"><select class="span11" name="kodeitem[]" id="kodeitem'+line+'">' +
    ...
    function tambahBudget(line) {
        ...
        row = 
            '<tr>' +
                '<td style="width: 90%;padding: 0px"><input class="budget span11" type="text" name="budget[]" id="budget'+line+'" style="width: 90%">' +
                 '<div style="margin-top: 5px">' +
                    '<input type="text" class="span11" name="linebudget[]" id="product'+line+'" value="'+line+'" style="display:none; width:350px;">' +
                '</div>' +
                '</td>' +
            '</tr>'
        rowItem.append(row); 
                        ...
                        <tr>
                            ...
                            <td style="width: 15%">
                                 <?php if($data->kodeitem == ''): ?>
                                    <table class="itembudget" id="tablebudget<?php echo e($data->seqid); ?>">
                                        <tr>
                                            <td style="width: 90%;padding: 0px" >
                                                <input class="budget span11" type="text" name="budget[]" id="budget1" value="<?php echo e($data->perkiraanbudget); ?>" style="width: 90%">
                                                <div style="margin-top: 5px">
                                                    <input type="text" class="span11" name="linebudget[]" id="product<?php echo e($data->seqid); ?>" value="<?php echo e($data->seqid); ?>" style="display:none;width:350px;">
                                                </div>
                                            </td>
                                    ...
                                    <input type="text" class="span11" name="linebudget[]" id="product" value="<?php echo e($data->seqid); ?>" style="display:none; width:350px;">
                                    <?php endif; ?>                   
                            </td>
                            <td style="width: 20%;">
                                 <?php if($data->kodeitem == '' || isnull($data->kodeitem)): ?>
                                    <table class="itemscode" id="tableitem<?php echo e($data->seqid); ?>">
                                        <tr>
                                            <td style="width: 90%;padding: 0px">
                                                <select class="span11" name="kodeitem[]" id="kodeitem1">
                                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($product->idqad); ?>"><?php echo e($product->nmprod); ?> - <?php echo e($product->idqad); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
