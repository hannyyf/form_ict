    ...
    $(document).ready(function(){
        ...
        $('#addItem').click(function() {
            ...
            '<tr>' +
                ...
                '</div>' +
                '</td>' +
                '<td style="width: 5%"><input class="span11" type="text" name="qty[]" id="qty" style="width:100%;"></td>' +
                '<td style="width: 4%">' +
...
<div class="container-fluid">
    <div class="row-fluid">
        <form action="<?php echo e(route('requestfppb.store')); ?>" method="post" class="form-horizontal">
        ...
        <div class="span12">
            <div class="control-group">
                ...
                <div class="controls">
                    <select class="form-control" name="divisi" id="divisi" style="width: 30%">
                    ...
                    <?php $__currentLoopData = $getdivision; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getdiv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($getdiv->div_id_bias); ?>"><?php echo e($getdiv->div_nama); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select class="form-control" name="kategori" id="kategori" style="width: 30%">
                    <option disabled="true">Choose One</option>
                ...
                <div class="widget-content nopadding">
                    <table class="table table-bordered table-striped table-responsive" id="table-list" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 25%">
                                <select class="form-control span11 jenisbarangc" name="jenisbarang[]" id="jenisbarang1" data-dependent="satuan" style="width: 100%">
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($product->idqad); ?>"><?php echo e($product->nmprod); ?> - <?php echo e($product->idqad); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <option value="other">Other</option>
                            ...
                            <td style="width: 5%">
                                <input class="qty span11" type="text" name="qty[]" id="qty" style="width:100%;">
                            </td>
                            <td style="width: 4%">
                                 <select class="form-control span11" name="satuan[]" id="satuan1" style="width:100%">
                                    <option value="">Pilih Satuan</option>
                                </select>
                            </td>
                            <td style="width: 3%">
                                <input class="span11" type="date" name="tanggalpakai[]" id="tanggalpakai" style="width: 100%">
                            </td>
                            <td style="width: 20%">
                                <textarea class="span11" type="text" name="keterangan[]" id="keterangan" rows="5" cols="40"></textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
